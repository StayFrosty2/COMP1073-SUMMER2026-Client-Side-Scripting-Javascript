...
let orig6 = "Toronto Maple Leafs, Chicago Blackhawks, Detroit Red Wings, Boston Bruins, Montreal Canadians, New York Rangers";
...
output.textContent = `The last team in the array are the ${orig6Array[orig6Array.length - 1]}.`;
