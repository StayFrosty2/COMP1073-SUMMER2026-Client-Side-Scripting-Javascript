...
output.textContent = `I get a ${breakDuration} minute break.`;
...
function setWeather() {
	...
	if (choice === "sunny") {
		...
		// change background to orange if warmer and light blue if cooler
		setBackgroundColor();
	}
...
function getWindSpeed() {
	...
	switch(speed) {
		...
		case 25:
			...
			break;
		default:
			windComment.textContent = speed + "km/h";
	}
