let courses = ['Intro to Web Programming', 'Client-Side JavaScript', 'Server-Side Scripting with ASP.NET', 'Web UI Design with CSS', 'Relational Databases'];
...
for (let i = 0; i < courses.length; i++) {
	// We are on the last course in the list
...
btn.addEventListener('click', function() {
	...
	for (let i = 0; i < cities.length; i++) {
		...
		if(searchName.toLowerCase().trim() === cities[i].toLowerCase()) {
