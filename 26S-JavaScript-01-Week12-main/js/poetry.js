...
function updateDisplay(verse) {
    console.log(`Selected Verse (inside the function): ${verse}`);
    // STEP 4: Declare and initialize URL to point to text file(s)
    let url = `https://stayfrosty2.github.io/COMP1073-SUMMER2026-Client-Side-Scripting-Javascript/26S-JavaScript-01-Week12-main/${verse}.txt`;
